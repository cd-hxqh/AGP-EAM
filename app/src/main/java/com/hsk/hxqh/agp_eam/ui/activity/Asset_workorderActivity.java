 ...
 */
public class Asset_workorderActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, SwipeRefreshLayout.OnLoadListener {
    ...
    private Asset_workAdapter bujianAdapter;
    ...
    protected void initView() {
        ...
        titleTextView.setText(getResources().getString(R.string.asset_workorder));
...
//        confirmBtn.setOnClickListener(confirmBtnOnClickListener);
        layoutManager = new LinearLayoutManager(Asset_workorderActivity.this);
...
//        mBasOut = new SlideBottomExit();
    ...
    public void onStart() {
        ...
        initAdapter(new ArrayList<ASSET_WORKORDER>());
    ...
    private void getData() {
        HttpManager.getDataPagingInfo(Asset_workorderActivity.this, HttpManager.getWorkorderUrl(asset.ASSETNUM,page, 20), new HttpRequestHandler<Results>() {
            @Override
            ...
            public void onSuccess(Results results, int totalPages, int currentPage) {
                ArrayList<ASSET_WORKORDER> item = JsonUtils.parsingASSET_WORKORDER(Asset_workorderActivity.this, results.getResultlist());
                ...
                if (item == null || item.isEmpty()) {
                    ...
                    if (item != null || item.size() != 0) {
                        if (page == 1) {
                            assetArrayList = new ArrayList<ASSET_WORKORDER>();
     ...
     * 获取数据*
     */
    private void initAdapter(final List<ASSET_WORKORDER> list) {
        bujianAdapter = new Asset_workAdapter(Asset_workorderActivity.this, R.layout.list_item_asset_work, list);
...
//                Intent intent = new Intent(Asset_workorderActivity.this, AssetDetailsActivity.class);
...
//                startActivityForResult(intent, 0);
     ...
     * 添加数据*
     */
    private void addData(final List<ASSET_WORKORDER> list) {
