 ...
 */
public class Udyearplan_chooseAdapter extends BaseQuickAdapter<UDYEARPLAN> {
    private int position;
    public Udyearplan_chooseAdapter(Context context, int layoutResId, List data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, UDYEARPLAN item) {
        CardView cardView = helper.getView(R.id.card_container);
        helper.setText(R.id.item_num_text, item.getPLANNUM());
