 ...
 */
public class Asset_beijianActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, SwipeRefreshLayout.OnLoadListener {
    ...
    private beijianAdapter bujianAdapter;
    private SwipeRefreshLayout refresh_layout = null;
    private int page = 1;
    public ASSET asset;
    public ArrayList<SPAREPART> assetArrayList = new ArrayList<>();
...
//        confirmBtn = (Button) findViewById(R.id.confirm);
    ...
    protected void initView() {
        ...
        titleTextView.setText(getResources().getString(R.string.asset_beijian));
...
//        confirmBtn.setOnClickListener(confirmBtnOnClickListener);
        layoutManager = new LinearLayoutManager(Asset_beijianActivity.this);
...
//        mBasOut = new SlideBottomExit();
    ...
    private void getData() {
        HttpManager.getDataPagingInfo(Asset_beijianActivity.this, HttpManager.getBeijianUrl(asset.ASSETNUM,page, 20), new HttpRequestHandler<Results>() {
            @Override
            ...
            public void onSuccess(Results results, int totalPages, int currentPage) {
                ArrayList<SPAREPART> item = JsonUtils.parsingSPAREPART(Asset_beijianActivity.this, results.getResultlist());
                ...
                if (item == null || item.isEmpty()) {
                    ...
                    if (item != null || item.size() != 0) {
                        if (page == 1) {
                            assetArrayList = new ArrayList<SPAREPART>();
    ...
    private void initAdapter(final List<SPAREPART> list) {
        bujianAdapter = new beijianAdapter(Asset_beijianActivity.this, R.layout.list_item_beijian, list);
