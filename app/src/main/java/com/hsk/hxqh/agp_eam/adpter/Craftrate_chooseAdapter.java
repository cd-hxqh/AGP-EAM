 ...
 */
public class Craftrate_chooseAdapter extends BaseQuickAdapter<CRAFTRATE> {
    private int position;
    public Craftrate_chooseAdapter(Context context, int layoutResId, List data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, CRAFTRATE item) {
        CardView cardView = helper.getView(R.id.card_container);
        helper.setText(R.id.item_num_text, item.getCRAFT());
