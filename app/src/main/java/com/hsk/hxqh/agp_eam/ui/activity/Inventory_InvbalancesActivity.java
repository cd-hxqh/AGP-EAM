...
//        mBasOut = new SlideBottomExit();
    ...
    private void getData() {
        HttpManager.getDataPagingInfo(Inventory_InvbalancesActivity.this, HttpManager.getInvbalancesUrl(inventory.getITEMNUM(),inventory.getLOCATION(),page, 20), new HttpRequestHandler<Results>() {
            @Override
